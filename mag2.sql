...
--
-- Host: 127.0.0.1
-- Creato il: Dic 16, 2016 alle 13:55
...
--
-- Struttura della tabella `admin_passwords`
--
...
--
-- Struttura della tabella `admin_system_messages`
--
...
--
-- Dump dei dati per la tabella `admin_system_messages`
--

INSERT INTO `admin_system_messages` (`identity`, `severity`, `created_at`) VALUES
('da332d712f3215b9b94bfa268c398323', 2, '2016-12-16 09:06:07');
...
(1, 'admin', 'admin', 'stefano.brambilla@triboo.it', 'admin', '7df5b1400e65aec75a280c033051cf05207b7f087f92fddfbd361b423760c3d0:W8KH1GKrpNVbc7uE7lwqsztiORBzCzSn:1', '2016-12-16 08:55:18', '2016-12-16 09:21:03', '2016-12-16 09:05:32', 1, 0, 1, 'a:1:{s:11:"configState";a:8:{s:14:"general_region";s:1:"0";s:15:"general_country";s:1:"0";s:24:"web_browser_capabilities";s:1:"1";s:11:"web_session";s:1:"1";s:10:"web_cookie";s:1:"1";s:11:"web_default";s:1:"1";s:12:"web_unsecure";s:1:"1";s:7:"web_seo";s:1:"0";}}', NULL, NULL, 'en_US', 0, NULL, NULL);

-- --------------------------------------------------------

--
-- Struttura della tabella `admin_user_session`
--
...
--
-- Dump dei dati per la tabella `admin_user_session`
--

INSERT INTO `admin_user_session` (`id`, `session_id`, `user_id`, `status`, `created_at`, `updated_at`, `ip`) VALUES
(1, '4aph4o3hltenk5nil2470elv20', 1, 1, '2016-12-16 09:05:32', '2016-12-16 09:30:08', '::1');

-- --------------------------------------------------------

--
-- Struttura della tabella `authorization_role`
--
...
--
-- Dump dei dati per la tabella `authorization_role`
--
...
--
-- Struttura della tabella `authorization_rule`
--
...
--
-- Dump dei dati per la tabella `authorization_rule`
--
...
--
-- Struttura della tabella `cache_tag`
--
...
--
-- Struttura della tabella `catalogsearch_fulltext_scope1`
--
...
(1, 3, 0, '2016-12-16 08:54:47', '2016-12-16 08:54:52', '1', 0, 0, 1),
(2, 3, 1, '2016-12-16 08:54:52', '2016-12-16 08:54:52', '1/2', 1, 1, 0);
...
--
-- Struttura della tabella `catalog_product_entity_media_gallery_value_to_entity`
--
...
--
-- Struttura della tabella `catalog_product_entity_media_gallery_value_video`
--
...
--
-- Struttura della tabella `catalog_url_rewrite_product_category`
--
...
(2, 'default', 0, 'web/unsecure/base_url', 'http://localhost/'),
(3, 'default', 0, 'web/secure/base_url', 'https://localhost/'),
(4, 'default', 0, 'general/locale/code', 'it_IT'),
(5, 'default', 0, 'web/secure/use_in_frontend', NULL),
(6, 'default', 0, 'web/secure/use_in_adminhtml', NULL),
(7, 'default', 0, 'general/locale/timezone', 'Europe/Rome'),
...
(27, 'default', 0, 'design/search_engine_robots/default_robots', 'INDEX,FOLLOW'),
(28, 'default', 0, 'design/search_engine_robots/custom_instructions', 'false'),
(29, 'default', 0, 'design/theme/theme_id', '2'),
...
(43, 'default', 0, 'design/email/logo_alt', NULL),
(44, 'default', 0, 'design/email/logo_width', NULL),
(45, 'default', 0, 'design/email/logo_height', NULL),
(46, 'default', 0, 'design/email/header_template', 'design_email_header_template'),
(47, 'default', 0, 'design/email/footer_template', 'design_email_footer_template'),
(48, 'default', 0, 'design/watermark/swatch_image_size', NULL),
(49, 'default', 0, 'design/watermark/swatch_image_imageOpacity', NULL),
(50, 'default', 0, 'design/watermark/swatch_image_position', 'stretch');
...
--
-- Dump dei dati per la tabella `customer_eav_attribute_website`
--
...
--
-- Struttura della tabella `customer_grid_flat`
--
...
--
-- Struttura della tabella `customer_log`
--
...
--
-- Struttura della tabella `customer_visitor`
--
...
--
-- Dump dei dati per la tabella `customer_visitor`
--

INSERT INTO `customer_visitor` (`visitor_id`, `customer_id`, `session_id`, `last_visit_at`) VALUES
(1, NULL, '1a69k0559bbr6m0d40pfl598h1', '2016-12-16 08:56:54'),
(2, NULL, '1iml3fjpeek7ni1cehskndpjb4', '2016-12-16 09:04:59'),
(3, NULL, 'n2rm4picki57ta7m082bjvbvf5', '2016-12-16 09:06:27'),
(4, NULL, 'beoe91k6m68jukn76s69lf6bj7', '2016-12-16 09:09:59'),
(5, NULL, '45mek0497hj10dtld785fl3bt1', '2016-12-16 09:29:51'),
(6, NULL, '6kbjlfs3jeqgurvmi146oiog86', '2016-12-16 10:58:27'),
(7, NULL, 'alihsja6b9m6i0pe4sagaui011', '2016-12-16 10:58:51'),
(8, NULL, 'qvqqokvt8c7k27mk1j3uoq3637', '2016-12-16 10:58:56'),
(9, NULL, '8t93oh9ej6iikksrbprta4fnh0', '2016-12-16 13:08:23'),
(10, NULL, '7hh0k7qiom8ftgcu69o2t1ovt1', '2016-12-16 13:09:50'),
(11, NULL, 'lm4it372vhn4hrv93ubripsar0', '2016-12-16 13:13:34'),
(12, NULL, 'hvk29q0jdf7f1ovlqp83u2ov86', '2016-12-16 13:13:46'),
(13, NULL, 'rk1ts345k7m9ui1u79h9homnt2', '2016-12-16 13:20:42'),
(14, NULL, '6sh0jnpss5f5c1agie58q5r6d5', '2016-12-16 13:21:31');
...
--
-- Struttura della tabella `design_config_grid_flat`
--
...
--
-- Dump dei dati per la tabella `design_config_grid_flat`
--
...
--
-- Struttura della tabella `eav_attribute_option_swatch`
--
...
--
-- Struttura della tabella `googleoptimizer_code`
--
...
--
-- Struttura della tabella `import_history`
--
...
--
-- Struttura della tabella `indexer_state`
--
...
--
-- Dump dei dati per la tabella `indexer_state`
--

INSERT INTO `indexer_state` (`state_id`, `indexer_id`, `status`, `updated`, `hash_config`) VALUES
(1, 'design_config_grid', 'valid', '2016-12-16 09:27:24', '27baa8fe6a5369f52c8b7cbd54a3c3c4'),
(2, 'customer_grid', 'valid', '2016-12-16 08:54:39', 'd572ea00944c9e3f517b3f46bad058a4'),
(3, 'catalog_category_product', 'invalid', '2016-12-16 08:54:39', '57b48d3cf1fcd64abe6b01dea3173d02'),
(4, 'catalog_product_category', 'invalid', '2016-12-16 08:54:39', '9957f66909342cc58ff2703dcd268bf4'),
(5, 'catalog_product_price', 'invalid', '2016-12-16 08:54:39', '15a819a577a149220cd0722c291de721'),
(6, 'catalog_product_attribute', 'invalid', '2016-12-16 08:54:39', '77eed0bf72b16099d299d0ab47b74910'),
(7, 'cataloginventory_stock', 'invalid', '2016-12-16 08:54:39', '78a405fd852458c326c85096099d7d5e'),
(8, 'catalogrule_rule', 'invalid', '2016-12-16 08:54:39', '5afe3cacdcb52ec3a7e68dc245679021'),
(9, 'catalogrule_product', 'invalid', '2016-12-16 08:54:39', '0ebee9e52ed424273132e8227fe646f3'),
(10, 'catalogsearch_fulltext', 'valid', '2016-12-16 08:55:03', '4486b57e2021aa78b526c68c9af2dcab');
...
--
-- Struttura della tabella `layout_link`
--
...
--
-- Struttura della tabella `layout_update`
--
...
--
-- Struttura della tabella `mview_state`
--
...
--
-- Struttura della tabella `oauth_token_request_log`
--
...
--
-- Struttura della tabella `password_reset_request_event`
--
...
--
-- Struttura della tabella `paypal_billing_agreement`
--
...
--
-- Struttura della tabella `paypal_billing_agreement_order`
--
...
--
-- Struttura della tabella `quote_address`
--
...
--
-- Struttura della tabella `quote_address_item`
--
...
--
-- Struttura della tabella `quote_id_mask`
--
...
--
-- Struttura della tabella `quote_item_option`
--
...
--
-- Struttura della tabella `quote_payment`
--
...
--
-- Struttura della tabella `quote_shipping_rate`
--
...
--
-- Struttura della tabella `reporting_counts`
--
...
--
-- Struttura della tabella `reporting_module_status`
--
...
--
-- Struttura della tabella `reporting_orders`
--
...
--
-- Struttura della tabella `reporting_system_updates`
--
...
--
-- Struttura della tabella `reporting_users`
--
...
--
-- Struttura della tabella `salesrule_coupon_aggregated`
--
...
--
-- Struttura della tabella `salesrule_coupon_aggregated_order`
--
...
--
-- Struttura della tabella `salesrule_coupon_aggregated_updated`
--
...
--
-- Struttura della tabella `sales_creditmemo`
--
...
--
-- Struttura della tabella `sales_creditmemo_comment`
--
...
--
-- Struttura della tabella `sales_creditmemo_grid`
--
...
--
-- Struttura della tabella `sales_creditmemo_item`
--
...
--
-- Struttura della tabella `sales_invoice`
--
...
--
-- Struttura della tabella `sales_invoice_comment`
--
...
--
-- Struttura della tabella `sales_invoice_grid`
--
...
--
-- Struttura della tabella `sales_invoice_item`
--
...
--
-- Struttura della tabella `sales_order_address`
--
...
--
-- Struttura della tabella `sales_order_grid`
--
...
--
-- Struttura della tabella `sales_order_payment`
--
...
--
-- Struttura della tabella `sales_order_status_history`
--
...
--
-- Struttura della tabella `sales_sequence_meta`
--
...
--
-- Dump dei dati per la tabella `sales_sequence_meta`
--
...
--
-- Struttura della tabella `sales_sequence_profile`
--
...
--
-- Dump dei dati per la tabella `sales_sequence_profile`
--
...
--
-- Struttura della tabella `sales_shipment`
--
...
--
-- Struttura della tabella `sales_shipment_comment`
--
...
--
-- Struttura della tabella `sales_shipment_grid`
--
...
--
-- Struttura della tabella `sales_shipment_item`
--
...
--
-- Struttura della tabella `sales_shipment_track`
--
...
--
-- Struttura della tabella `search_query`
--
...
--
-- Struttura della tabella `search_synonyms`
--
...
--
-- Struttura della tabella `sequence_creditmemo_0`
--
...
--
-- Struttura della tabella `sequence_creditmemo_1`
--
...
--
-- Struttura della tabella `sequence_invoice_0`
--
...
--
-- Struttura della tabella `sequence_invoice_1`
--
...
--
-- Struttura della tabella `sequence_order_0`
--
...
--
-- Struttura della tabella `sequence_order_1`
--
...
--
-- Struttura della tabella `sequence_shipment_0`
--
...
--
-- Struttura della tabella `sequence_shipment_1`
--
...
--
-- Struttura della tabella `setup_module`
--
...
--
-- Dump dei dati per la tabella `setup_module`
--
...
('Magento_CatalogInventory', '2.2.0', '2.2.0'),
...
--
-- Struttura della tabella `store_group`
--
...
--
-- Dump dei dati per la tabella `store_group`
--
...
--
-- Struttura della tabella `store_website`
--
...
--
-- Dump dei dati per la tabella `store_website`
--
...
--
-- Dump dei dati per la tabella `theme`
--
...
(2, NULL, 'Magento/blank', 'Magento Blank', 'preview_image_5853abbd270aa.jpeg', 0, 'frontend', 0, 'Magento/blank'),
(3, 2, 'Magento/luma', 'Magento Luma', 'preview_image_5853abbd5cda1.jpeg', 0, 'frontend', 0, 'Magento/luma'),
(4, NULL, 'Magento/blank_orig', 'Magento Blank Original', 'preview_image_5853c8c41f33b.jpeg', 0, 'frontend', 0, 'Magento/blank_orig'),
(5, NULL, 'Magento/blank_sass', 'Blank Sass', 'preview_image_5853c8c45050c.jpeg', 0, 'frontend', 0, 'Magento/blank_sass');

-- --------------------------------------------------------

--
-- Struttura della tabella `theme_file`
--
...
--
-- Struttura della tabella `translation`
--
...
--
-- Struttura della tabella `ui_bookmark`
--
...
--
-- Dump dei dati per la tabella `url_rewrite`
--
...
--
-- Struttura della tabella `variable_value`
--
...
--
-- Struttura della tabella `vault_payment_token`
--
...
--
-- Struttura della tabella `vault_payment_token_order_payment_link`
--
...
--
-- Indici per le tabelle `adminnotification_inbox`
--
...
--
-- Indici per le tabelle `admin_passwords`
--
...
--
-- Indici per le tabelle `admin_system_messages`
--
...
--
-- Indici per le tabelle `admin_user_session`
--
...
--
-- Indici per le tabelle `authorization_role`
--
...
--
-- Indici per le tabelle `authorization_rule`
--
...
--
-- Indici per le tabelle `cache_tag`
--
...
--
-- Indici per le tabelle `captcha_log`
--
ALTER TABLE `captcha_log`
  ADD PRIMARY KEY (`type`,`value`);

--
-- Indici per le tabelle `cataloginventory_stock`
--
...
--
-- Indici per le tabelle `cataloginventory_stock_item`
--
...
--
-- Indici per le tabelle `cataloginventory_stock_status`
--
...
--
-- Indici per le tabelle `cataloginventory_stock_status_idx`
--
...
--
-- Indici per le tabelle `cataloginventory_stock_status_tmp`
--
...
--
-- Indici per le tabelle `catalogrule`
--
...
--
-- Indici per le tabelle `catalogrule_customer_group`
--
...
--
-- Indici per le tabelle `catalogrule_group_website`
--
...
--
-- Indici per le tabelle `catalogrule_product`
--
...
--
-- Indici per le tabelle `catalogrule_product_price`
--
...
--
-- Indici per le tabelle `catalogrule_website`
--
...
--
-- Indici per le tabelle `catalogsearch_fulltext_scope1`
--
...
--
-- Indici per le tabelle `catalog_category_entity`
--
...
--
-- Indici per le tabelle `catalog_category_entity_datetime`
--
...
--
-- Indici per le tabelle `catalog_category_entity_decimal`
--
...
--
-- Indici per le tabelle `catalog_category_entity_int`
--
...
--
-- Indici per le tabelle `catalog_category_entity_text`
--
...
--
-- Indici per le tabelle `catalog_category_entity_varchar`
--
...
--
-- Indici per le tabelle `catalog_category_product`
--
...
--
-- Indici per le tabelle `catalog_category_product_index`
--
...
--
-- Indici per le tabelle `catalog_category_product_index_tmp`
--
...
--
-- Indici per le tabelle `catalog_compare_item`
--
...
--
-- Indici per le tabelle `catalog_eav_attribute`
--
...
--
-- Indici per le tabelle `catalog_product_bundle_option`
--
...
--
-- Indici per le tabelle `catalog_product_bundle_option_value`
--
...
--
-- Indici per le tabelle `catalog_product_bundle_price_index`
--
...
--
-- Indici per le tabelle `catalog_product_bundle_selection`
--
...
--
-- Indici per le tabelle `catalog_product_bundle_selection_price`
--
...
--
-- Indici per le tabelle `catalog_product_entity_datetime`
--
...
--
-- Indici per le tabelle `catalog_product_entity_decimal`
--
...
--
-- Indici per le tabelle `catalog_product_entity_gallery`
--
...
--
-- Indici per le tabelle `catalog_product_entity_int`
--
...
--
-- Indici per le tabelle `catalog_product_entity_media_gallery`
--
...
--
-- Indici per le tabelle `catalog_product_entity_media_gallery_value`
--
...
--
-- Indici per le tabelle `catalog_product_entity_media_gallery_value_to_entity`
--
...
--
-- Indici per le tabelle `catalog_product_entity_media_gallery_value_video`
--
...
--
-- Indici per le tabelle `catalog_product_entity_text`
--
...
--
-- Indici per le tabelle `catalog_product_entity_tier_price`
--
...
--
-- Indici per le tabelle `catalog_product_entity_varchar`
--
...
--
-- Indici per le tabelle `catalog_product_index_eav`
--
...
--
-- Indici per le tabelle `catalog_product_index_eav_decimal`
--
...
--
-- Indici per le tabelle `catalog_product_index_eav_decimal_idx`
--
...
--
-- Indici per le tabelle `catalog_product_index_eav_decimal_tmp`
--
...
--
-- Indici per le tabelle `catalog_product_index_eav_idx`
--
...
--
-- Indici per le tabelle `catalog_product_index_eav_tmp`
--
...
--
-- Indici per le tabelle `catalog_product_index_price`
--
...
--
-- Indici per le tabelle `catalog_product_index_price_bundle_idx`
--
ALTER TABLE `catalog_product_index_price_bundle_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_bundle_opt_idx`
--
ALTER TABLE `catalog_product_index_price_bundle_opt_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`);

--
-- Indici per le tabelle `catalog_product_index_price_bundle_opt_tmp`
--
ALTER TABLE `catalog_product_index_price_bundle_opt_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`);

--
-- Indici per le tabelle `catalog_product_index_price_bundle_sel_idx`
--
...
--
-- Indici per le tabelle `catalog_product_index_price_bundle_sel_tmp`
--
ALTER TABLE `catalog_product_index_price_bundle_sel_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`,`selection_id`);

--
-- Indici per le tabelle `catalog_product_index_price_bundle_tmp`
--
ALTER TABLE `catalog_product_index_price_bundle_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_cfg_opt_agr_idx`
--
ALTER TABLE `catalog_product_index_price_cfg_opt_agr_idx`
  ADD PRIMARY KEY (`parent_id`,`child_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_cfg_opt_agr_tmp`
--
ALTER TABLE `catalog_product_index_price_cfg_opt_agr_tmp`
  ADD PRIMARY KEY (`parent_id`,`child_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_cfg_opt_idx`
--
ALTER TABLE `catalog_product_index_price_cfg_opt_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_cfg_opt_tmp`
--
ALTER TABLE `catalog_product_index_price_cfg_opt_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_downlod_idx`
--
ALTER TABLE `catalog_product_index_price_downlod_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_downlod_tmp`
--
ALTER TABLE `catalog_product_index_price_downlod_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_final_idx`
--
ALTER TABLE `catalog_product_index_price_final_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_final_tmp`
--
ALTER TABLE `catalog_product_index_price_final_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_idx`
--
...
--
-- Indici per le tabelle `catalog_product_index_price_opt_agr_idx`
--
ALTER TABLE `catalog_product_index_price_opt_agr_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`);

--
-- Indici per le tabelle `catalog_product_index_price_opt_agr_tmp`
--
ALTER TABLE `catalog_product_index_price_opt_agr_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`,`option_id`);

--
-- Indici per le tabelle `catalog_product_index_price_opt_idx`
--
ALTER TABLE `catalog_product_index_price_opt_idx`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_opt_tmp`
--
ALTER TABLE `catalog_product_index_price_opt_tmp`
  ADD PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`);

--
-- Indici per le tabelle `catalog_product_index_price_tmp`
--
...
--
-- Indici per le tabelle `catalog_product_index_tier_price`
--
...
--
-- Indici per le tabelle `catalog_product_index_website`
--
...
--
-- Indici per le tabelle `catalog_product_link`
--
...
--
-- Indici per le tabelle `catalog_product_link_attribute`
--
...
--
-- Indici per le tabelle `catalog_product_link_attribute_decimal`
--
...
--
-- Indici per le tabelle `catalog_product_link_attribute_int`
--
...
--
-- Indici per le tabelle `catalog_product_link_attribute_varchar`
--
...
--
-- Indici per le tabelle `catalog_product_link_type`
--
ALTER TABLE `catalog_product_link_type`
  ADD PRIMARY KEY (`link_type_id`);

--
-- Indici per le tabelle `catalog_product_option`
--
...
--
-- Indici per le tabelle `catalog_product_option_price`
--
...
--
-- Indici per le tabelle `catalog_product_option_title`
--
...
--
-- Indici per le tabelle `catalog_product_option_type_price`
--
...
--
-- Indici per le tabelle `catalog_product_option_type_title`
--
...
--
-- Indici per le tabelle `catalog_product_option_type_value`
--
...
--
-- Indici per le tabelle `catalog_product_relation`
--
...
--
-- Indici per le tabelle `catalog_product_super_attribute`
--
...
--
-- Indici per le tabelle `catalog_product_super_attribute_label`
--
...
--
-- Indici per le tabelle `catalog_product_super_link`
--
...
--
-- Indici per le tabelle `catalog_product_website`
--
...
--
-- Indici per le tabelle `catalog_url_rewrite_product_category`
--
...
--
-- Indici per le tabelle `checkout_agreement`
--
ALTER TABLE `checkout_agreement`
  ADD PRIMARY KEY (`agreement_id`);

--
-- Indici per le tabelle `checkout_agreement_store`
--
...
--
-- Indici per le tabelle `cms_block`
--
...
--
-- Indici per le tabelle `cms_block_store`
--
...
--
-- Indici per le tabelle `cms_page`
--
...
--
-- Indici per le tabelle `cms_page_store`
--
...
--
-- Indici per le tabelle `core_config_data`
--
...
--
-- Indici per le tabelle `cron_schedule`
--
...
--
-- Indici per le tabelle `customer_address_entity`
--
...
--
-- Indici per le tabelle `customer_address_entity_datetime`
--
...
--
-- Indici per le tabelle `customer_address_entity_decimal`
--
...
--
-- Indici per le tabelle `customer_address_entity_int`
--
...
--
-- Indici per le tabelle `customer_address_entity_text`
--
...
--
-- Indici per le tabelle `customer_address_entity_varchar`
--
...
--
-- Indici per le tabelle `customer_eav_attribute`
--
ALTER TABLE `customer_eav_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Indici per le tabelle `customer_eav_attribute_website`
--
...
--
-- Indici per le tabelle `customer_entity`
--
...
--
-- Indici per le tabelle `customer_entity_datetime`
--
...
--
-- Indici per le tabelle `customer_entity_decimal`
--
...
--
-- Indici per le tabelle `customer_entity_int`
--
...
--
-- Indici per le tabelle `customer_entity_text`
--
...
--
-- Indici per le tabelle `customer_entity_varchar`
--
...
--
-- Indici per le tabelle `customer_form_attribute`
--
...
--
-- Indici per le tabelle `customer_grid_flat`
--
...
--
-- Indici per le tabelle `customer_log`
--
...
--
-- Indici per le tabelle `customer_visitor`
--
...
--
-- Indici per le tabelle `design_change`
--
...
--
-- Indici per le tabelle `design_config_grid_flat`
--
...
--
-- Indici per le tabelle `directory_country`
--
ALTER TABLE `directory_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Indici per le tabelle `directory_country_format`
--
...
--
-- Indici per le tabelle `directory_country_region`
--
...
--
-- Indici per le tabelle `directory_country_region_name`
--
...
--
-- Indici per le tabelle `directory_currency_rate`
--
...
--
-- Indici per le tabelle `downloadable_link`
--
...
--
-- Indici per le tabelle `downloadable_link_price`
--
...
--
-- Indici per le tabelle `downloadable_link_purchased`
--
...
--
-- Indici per le tabelle `downloadable_link_purchased_item`
--
...
--
-- Indici per le tabelle `downloadable_link_title`
--
...
--
-- Indici per le tabelle `downloadable_sample`
--
...
--
-- Indici per le tabelle `downloadable_sample_title`
--
...
--
-- Indici per le tabelle `eav_attribute`
--
...
--
-- Indici per le tabelle `eav_attribute_group`
--
...
--
-- Indici per le tabelle `eav_attribute_label`
--
...
--
-- Indici per le tabelle `eav_attribute_option`
--
...
--
-- Indici per le tabelle `eav_attribute_option_swatch`
--
...
--
-- Indici per le tabelle `eav_attribute_option_value`
--
...
--
-- Indici per le tabelle `eav_attribute_set`
--
...
--
-- Indici per le tabelle `eav_entity`
--
...
--
-- Indici per le tabelle `eav_entity_attribute`
--
...
--
-- Indici per le tabelle `eav_entity_datetime`
--
...
--
-- Indici per le tabelle `eav_entity_decimal`
--
...
--
-- Indici per le tabelle `eav_entity_int`
--
...
--
-- Indici per le tabelle `eav_entity_store`
--
...
--
-- Indici per le tabelle `eav_entity_text`
--
...
--
-- Indici per le tabelle `eav_entity_type`
--
...
--
-- Indici per le tabelle `eav_entity_varchar`
--
...
--
-- Indici per le tabelle `eav_form_element`
--
...
--
-- Indici per le tabelle `eav_form_fieldset`
--
...
--
-- Indici per le tabelle `eav_form_fieldset_label`
--
...
--
-- Indici per le tabelle `eav_form_type`
--
...
--
-- Indici per le tabelle `eav_form_type_entity`
--
...
--
-- Indici per le tabelle `gift_message`
--
ALTER TABLE `gift_message`
  ADD PRIMARY KEY (`gift_message_id`);

--
-- Indici per le tabelle `googleoptimizer_code`
--
...
--
-- Indici per le tabelle `importexport_importdata`
--
ALTER TABLE `importexport_importdata`
  ADD PRIMARY KEY (`id`);

--
-- Indici per le tabelle `import_history`
--
ALTER TABLE `import_history`
  ADD PRIMARY KEY (`history_id`);

--
-- Indici per le tabelle `indexer_state`
--
...
--
-- Indici per le tabelle `layout_link`
--
...
--
-- Indici per le tabelle `layout_update`
--
...
--
-- Indici per le tabelle `mview_state`
--
...
--
-- Indici per le tabelle `newsletter_problem`
--
...
--
-- Indici per le tabelle `newsletter_queue`
--
...
--
-- Indici per le tabelle `newsletter_queue_link`
--
...
--
-- Indici per le tabelle `newsletter_queue_store_link`
--
...
--
-- Indici per le tabelle `newsletter_subscriber`
--
...
--
-- Indici per le tabelle `newsletter_template`
--
...
--
-- Indici per le tabelle `oauth_consumer`
--
...
--
-- Indici per le tabelle `oauth_nonce`
--
...
--
-- Indici per le tabelle `oauth_token`
--
...
--
-- Indici per le tabelle `oauth_token_request_log`
--
...
--
-- Indici per le tabelle `password_reset_request_event`
--
...
--
-- Indici per le tabelle `paypal_billing_agreement`
--
...
--
-- Indici per le tabelle `paypal_billing_agreement_order`
--
...
--
-- Indici per le tabelle `paypal_cert`
--
...
--
-- Indici per le tabelle `paypal_payment_transaction`
--
...
--
-- Indici per le tabelle `paypal_settlement_report`
--
...
--
-- Indici per le tabelle `paypal_settlement_report_row`
--
...
--
-- Indici per le tabelle `persistent_session`
--
...
--
-- Indici per le tabelle `product_alert_price`
--
...
--
-- Indici per le tabelle `product_alert_stock`
--
...
--
-- Indici per le tabelle `quote_address`
--
...
--
-- Indici per le tabelle `quote_address_item`
--
...
--
-- Indici per le tabelle `quote_id_mask`
--
...
--
-- Indici per le tabelle `quote_item_option`
--
...
--
-- Indici per le tabelle `quote_payment`
--
...
--
-- Indici per le tabelle `quote_shipping_rate`
--
...
--
-- Indici per le tabelle `rating_entity`
--
...
--
-- Indici per le tabelle `rating_option`
--
...
--
-- Indici per le tabelle `rating_option_vote`
--
...
--
-- Indici per le tabelle `rating_option_vote_aggregated`
--
...
--
-- Indici per le tabelle `rating_store`
--
...
--
-- Indici per le tabelle `rating_title`
--
...
--
-- Indici per le tabelle `reporting_counts`
--
ALTER TABLE `reporting_counts`
  ADD PRIMARY KEY (`entity_id`);

--
-- Indici per le tabelle `reporting_module_status`
--
ALTER TABLE `reporting_module_status`
  ADD PRIMARY KEY (`entity_id`);

--
-- Indici per le tabelle `reporting_orders`
--
ALTER TABLE `reporting_orders`
  ADD PRIMARY KEY (`entity_id`);

--
-- Indici per le tabelle `reporting_system_updates`
--
ALTER TABLE `reporting_system_updates`
  ADD PRIMARY KEY (`entity_id`);

--
-- Indici per le tabelle `reporting_users`
--
ALTER TABLE `reporting_users`
  ADD PRIMARY KEY (`entity_id`);

--
-- Indici per le tabelle `report_compared_product_index`
--
...
--
-- Indici per le tabelle `report_event`
--
...
--
-- Indici per le tabelle `report_event_types`
--
ALTER TABLE `report_event_types`
  ADD PRIMARY KEY (`event_type_id`);

--
-- Indici per le tabelle `report_viewed_product_aggregated_daily`
--
...
--
-- Indici per le tabelle `report_viewed_product_aggregated_monthly`
--
...
--
-- Indici per le tabelle `report_viewed_product_aggregated_yearly`
--
...
--
-- Indici per le tabelle `report_viewed_product_index`
--
...
--
-- Indici per le tabelle `review_detail`
--
...
--
-- Indici per le tabelle `review_entity`
--
ALTER TABLE `review_entity`
  ADD PRIMARY KEY (`entity_id`);

--
-- Indici per le tabelle `review_entity_summary`
--
...
--
-- Indici per le tabelle `review_status`
--
ALTER TABLE `review_status`
  ADD PRIMARY KEY (`status_id`);

--
-- Indici per le tabelle `review_store`
--
...
--
-- Indici per le tabelle `salesrule`
--
...
--
-- Indici per le tabelle `salesrule_coupon`
--
...
--
-- Indici per le tabelle `salesrule_coupon_aggregated`
--
...
--
-- Indici per le tabelle `salesrule_coupon_aggregated_order`
--
...
--
-- Indici per le tabelle `salesrule_coupon_aggregated_updated`
--
...
--
-- Indici per le tabelle `salesrule_coupon_usage`
--
...
--
-- Indici per le tabelle `salesrule_customer`
--
...
--
-- Indici per le tabelle `salesrule_customer_group`
--
...
--
-- Indici per le tabelle `salesrule_label`
--
...
--
-- Indici per le tabelle `salesrule_product_attribute`
--
...
--
-- Indici per le tabelle `salesrule_website`
--
...
--
-- Indici per le tabelle `sales_bestsellers_aggregated_daily`
--
...
--
-- Indici per le tabelle `sales_bestsellers_aggregated_monthly`
--
...
--
-- Indici per le tabelle `sales_bestsellers_aggregated_yearly`
--
...
--
-- Indici per le tabelle `sales_creditmemo`
--
...
--
-- Indici per le tabelle `sales_creditmemo_comment`
--
...
--
-- Indici per le tabelle `sales_creditmemo_grid`
--
...
--
-- Indici per le tabelle `sales_creditmemo_item`
--
...
--
-- Indici per le tabelle `sales_invoice`
--
...
--
-- Indici per le tabelle `sales_invoiced_aggregated`
--
...
--
-- Indici per le tabelle `sales_invoiced_aggregated_order`
--
...
--
-- Indici per le tabelle `sales_invoice_comment`
--
...
--
-- Indici per le tabelle `sales_invoice_grid`
--
...
--
-- Indici per le tabelle `sales_invoice_item`
--
...
--
-- Indici per le tabelle `sales_order_address`
--
...
--
-- Indici per le tabelle `sales_order_aggregated_created`
--
...
--
-- Indici per le tabelle `sales_order_aggregated_updated`
--
...
--
-- Indici per le tabelle `sales_order_grid`
--
...
--
-- Indici per le tabelle `sales_order_payment`
--
...
--
-- Indici per le tabelle `sales_order_status`
--
ALTER TABLE `sales_order_status`
  ADD PRIMARY KEY (`status`);

--
-- Indici per le tabelle `sales_order_status_history`
--
...
--
-- Indici per le tabelle `sales_order_status_label`
--
...
--
-- Indici per le tabelle `sales_order_status_state`
--
ALTER TABLE `sales_order_status_state`
  ADD PRIMARY KEY (`status`,`state`);

--
-- Indici per le tabelle `sales_order_tax`
--
...
--
-- Indici per le tabelle `sales_order_tax_item`
--
...
--
-- Indici per le tabelle `sales_payment_transaction`
--
...
--
-- Indici per le tabelle `sales_refunded_aggregated`
--
...
--
-- Indici per le tabelle `sales_refunded_aggregated_order`
--
...
--
-- Indici per le tabelle `sales_sequence_meta`
--
...
--
-- Indici per le tabelle `sales_sequence_profile`
--
...
--
-- Indici per le tabelle `sales_shipment`
--
...
--
-- Indici per le tabelle `sales_shipment_comment`
--
...
--
-- Indici per le tabelle `sales_shipment_grid`
--
...
--
-- Indici per le tabelle `sales_shipment_item`
--
...
--
-- Indici per le tabelle `sales_shipment_track`
--
...
--
-- Indici per le tabelle `sales_shipping_aggregated`
--
...
--
-- Indici per le tabelle `sales_shipping_aggregated_order`
--
...
--
-- Indici per le tabelle `search_query`
--
...
--
-- Indici per le tabelle `search_synonyms`
--
...
--
-- Indici per le tabelle `sendfriend_log`
--
...
--
-- Indici per le tabelle `sequence_creditmemo_0`
--
ALTER TABLE `sequence_creditmemo_0`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Indici per le tabelle `sequence_creditmemo_1`
--
ALTER TABLE `sequence_creditmemo_1`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Indici per le tabelle `sequence_invoice_0`
--
ALTER TABLE `sequence_invoice_0`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Indici per le tabelle `sequence_invoice_1`
--
ALTER TABLE `sequence_invoice_1`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Indici per le tabelle `sequence_order_0`
--
ALTER TABLE `sequence_order_0`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Indici per le tabelle `sequence_order_1`
--
ALTER TABLE `sequence_order_1`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Indici per le tabelle `sequence_shipment_0`
--
ALTER TABLE `sequence_shipment_0`
  ADD PRIMARY KEY (`sequence_value`);

--
-- Indici per le tabelle `sequence_shipment_1`
--
...
--
-- Indici per le tabelle `setup_module`
--
ALTER TABLE `setup_module`
  ADD PRIMARY KEY (`module`);

--
-- Indici per le tabelle `shipping_tablerate`
--
...
--
-- Indici per le tabelle `store_group`
--
...
--
-- Indici per le tabelle `store_website`
--
...
--
-- Indici per le tabelle `tax_calculation`
--
...
--
-- Indici per le tabelle `tax_calculation_rate`
--
...
--
-- Indici per le tabelle `tax_calculation_rate_title`
--
...
--
-- Indici per le tabelle `tax_calculation_rule`
--
...
--
-- Indici per le tabelle `tax_order_aggregated_created`
--
...
--
-- Indici per le tabelle `tax_order_aggregated_updated`
--
...
--
-- Indici per le tabelle `theme_file`
--
...
--
-- Indici per le tabelle `translation`
--
...
--
-- Indici per le tabelle `ui_bookmark`
--
...
--
-- Indici per le tabelle `url_rewrite`
--
...
--
-- Indici per le tabelle `variable_value`
--
...
--
-- Indici per le tabelle `vault_payment_token`
--
...
--
-- Indici per le tabelle `vault_payment_token_order_payment_link`
--
...
--
-- Indici per le tabelle `weee_tax`
--
...
--
-- Indici per le tabelle `widget_instance`
--
...
--
-- Indici per le tabelle `widget_instance_page`
--
...
--
-- Indici per le tabelle `widget_instance_page_layout`
--
...
--
-- Indici per le tabelle `wishlist_item`
--
...
--
-- Indici per le tabelle `wishlist_item_option`
--
...
--
-- AUTO_INCREMENT per la tabella `adminnotification_inbox`
--
ALTER TABLE `adminnotification_inbox`
  MODIFY `notification_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Notification id';
--
-- AUTO_INCREMENT per la tabella `admin_passwords`
--
ALTER TABLE `admin_passwords`
...
--
-- AUTO_INCREMENT per la tabella `admin_user_session`
--
ALTER TABLE `admin_user_session`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity ID', AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT per la tabella `authorization_role`
--
ALTER TABLE `authorization_role`
  MODIFY `role_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Role ID', AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT per la tabella `authorization_rule`
--
ALTER TABLE `authorization_rule`
  MODIFY `rule_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Rule ID', AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT per la tabella `cataloginventory_stock`
--
ALTER TABLE `cataloginventory_stock`
  MODIFY `stock_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Stock Id', AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT per la tabella `cataloginventory_stock_item`
--
ALTER TABLE `cataloginventory_stock_item`
  MODIFY `item_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Item Id';
--
-- AUTO_INCREMENT per la tabella `catalogrule`
--
ALTER TABLE `catalogrule`
  MODIFY `rule_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Rule Id';
--
-- AUTO_INCREMENT per la tabella `catalogrule_product`
--
ALTER TABLE `catalogrule_product`
  MODIFY `rule_product_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Rule Product Id';
--
-- AUTO_INCREMENT per la tabella `catalogrule_product_price`
--
ALTER TABLE `catalogrule_product_price`
  MODIFY `rule_product_price_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Rule Product PriceId';
--
-- AUTO_INCREMENT per la tabella `catalog_category_entity`
--
ALTER TABLE `catalog_category_entity`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity ID', AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT per la tabella `catalog_category_entity_datetime`
--
ALTER TABLE `catalog_category_entity_datetime`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_category_entity_decimal`
--
ALTER TABLE `catalog_category_entity_decimal`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_category_entity_int`
--
ALTER TABLE `catalog_category_entity_int`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID', AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT per la tabella `catalog_category_entity_text`
--
ALTER TABLE `catalog_category_entity_text`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_category_entity_varchar`
--
ALTER TABLE `catalog_category_entity_varchar`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID', AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT per la tabella `catalog_category_product`
--
ALTER TABLE `catalog_category_product`
  MODIFY `entity_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Entity ID';
--
-- AUTO_INCREMENT per la tabella `catalog_compare_item`
--
ALTER TABLE `catalog_compare_item`
  MODIFY `catalog_compare_item_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Compare Item ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_bundle_option`
--
ALTER TABLE `catalog_product_bundle_option`
  MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Option Id';
--
-- AUTO_INCREMENT per la tabella `catalog_product_bundle_option_value`
--
ALTER TABLE `catalog_product_bundle_option_value`
  MODIFY `value_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT per la tabella `catalog_product_bundle_selection`
--
ALTER TABLE `catalog_product_bundle_selection`
  MODIFY `selection_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Selection Id';
--
-- AUTO_INCREMENT per la tabella `catalog_product_entity`
--
ALTER TABLE `catalog_product_entity`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_entity_datetime`
--
ALTER TABLE `catalog_product_entity_datetime`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_entity_decimal`
--
ALTER TABLE `catalog_product_entity_decimal`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_entity_gallery`
--
ALTER TABLE `catalog_product_entity_gallery`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_entity_int`
--
ALTER TABLE `catalog_product_entity_int`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_entity_media_gallery`
--
ALTER TABLE `catalog_product_entity_media_gallery`
  MODIFY `value_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_entity_media_gallery_value`
--
ALTER TABLE `catalog_product_entity_media_gallery_value`
  MODIFY `record_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Record Id';
--
-- AUTO_INCREMENT per la tabella `catalog_product_entity_text`
--
ALTER TABLE `catalog_product_entity_text`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_entity_tier_price`
--
ALTER TABLE `catalog_product_entity_tier_price`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_entity_varchar`
--
ALTER TABLE `catalog_product_entity_varchar`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_link`
--
ALTER TABLE `catalog_product_link`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Link ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_link_attribute`
--
ALTER TABLE `catalog_product_link_attribute`
...
--
-- AUTO_INCREMENT per la tabella `catalog_product_link_attribute_decimal`
--
ALTER TABLE `catalog_product_link_attribute_decimal`
  MODIFY `value_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_link_attribute_int`
--
ALTER TABLE `catalog_product_link_attribute_int`
  MODIFY `value_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_link_attribute_varchar`
--
ALTER TABLE `catalog_product_link_attribute_varchar`
  MODIFY `value_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_link_type`
--
ALTER TABLE `catalog_product_link_type`
  MODIFY `link_type_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Link Type ID', AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT per la tabella `catalog_product_option`
--
ALTER TABLE `catalog_product_option`
  MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Option ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_option_price`
--
ALTER TABLE `catalog_product_option_price`
  MODIFY `option_price_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Option Price ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_option_title`
--
ALTER TABLE `catalog_product_option_title`
  MODIFY `option_title_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Option Title ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_option_type_price`
--
ALTER TABLE `catalog_product_option_type_price`
  MODIFY `option_type_price_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Option Type Price ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_option_type_title`
--
ALTER TABLE `catalog_product_option_type_title`
  MODIFY `option_type_title_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Option Type Title ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_option_type_value`
--
ALTER TABLE `catalog_product_option_type_value`
  MODIFY `option_type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Option Type ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_super_attribute`
--
ALTER TABLE `catalog_product_super_attribute`
  MODIFY `product_super_attribute_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Product Super Attribute ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_super_attribute_label`
--
ALTER TABLE `catalog_product_super_attribute_label`
  MODIFY `value_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Value ID';
--
-- AUTO_INCREMENT per la tabella `catalog_product_super_link`
--
ALTER TABLE `catalog_product_super_link`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Link ID';
--
-- AUTO_INCREMENT per la tabella `checkout_agreement`
--
ALTER TABLE `checkout_agreement`
  MODIFY `agreement_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Agreement Id';
--
-- AUTO_INCREMENT per la tabella `cms_block`
--
ALTER TABLE `cms_block`
  MODIFY `block_id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'Block ID';
--
-- AUTO_INCREMENT per la tabella `cms_page`
--
ALTER TABLE `cms_page`
  MODIFY `page_id` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'Page ID', AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT per la tabella `core_config_data`
--
ALTER TABLE `core_config_data`
  MODIFY `config_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Config Id', AUTO_INCREMENT=51;
--
-- AUTO_INCREMENT per la tabella `cron_schedule`
--
ALTER TABLE `cron_schedule`
  MODIFY `schedule_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Schedule Id';
--
-- AUTO_INCREMENT per la tabella `customer_address_entity`
--
ALTER TABLE `customer_address_entity`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `customer_address_entity_datetime`
--
ALTER TABLE `customer_address_entity_datetime`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT per la tabella `customer_address_entity_decimal`
--
ALTER TABLE `customer_address_entity_decimal`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT per la tabella `customer_address_entity_int`
--
ALTER TABLE `customer_address_entity_int`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT per la tabella `customer_address_entity_text`
--
ALTER TABLE `customer_address_entity_text`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT per la tabella `customer_address_entity_varchar`
--
ALTER TABLE `customer_address_entity_varchar`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT per la tabella `customer_entity`
--
ALTER TABLE `customer_entity`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `customer_entity_datetime`
--
ALTER TABLE `customer_entity_datetime`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT per la tabella `customer_entity_decimal`
--
ALTER TABLE `customer_entity_decimal`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT per la tabella `customer_entity_int`
--
ALTER TABLE `customer_entity_int`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT per la tabella `customer_entity_text`
--
ALTER TABLE `customer_entity_text`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
-- AUTO_INCREMENT per la tabella `customer_entity_varchar`
--
ALTER TABLE `customer_entity_varchar`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
...
ALTER TABLE `quote`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `quote_address`
--
ALTER TABLE `quote_address`
  MODIFY `address_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Address Id';
--
-- AUTO_INCREMENT per la tabella `quote_address_item`
--
ALTER TABLE `quote_address_item`
  MODIFY `address_item_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Address Item Id';
--
-- AUTO_INCREMENT per la tabella `quote_id_mask`
--
ALTER TABLE `quote_id_mask`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `quote_item`
--
ALTER TABLE `quote_item`
  MODIFY `item_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Item Id';
--
-- AUTO_INCREMENT per la tabella `quote_item_option`
--
ALTER TABLE `quote_item_option`
  MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Option Id';
--
-- AUTO_INCREMENT per la tabella `quote_payment`
--
ALTER TABLE `quote_payment`
  MODIFY `payment_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Payment Id';
--
-- AUTO_INCREMENT per la tabella `quote_shipping_rate`
--
ALTER TABLE `quote_shipping_rate`
...
--
-- AUTO_INCREMENT per la tabella `rating_entity`
--
ALTER TABLE `rating_entity`
  MODIFY `entity_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id', AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT per la tabella `rating_option`
--
ALTER TABLE `rating_option`
  MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Rating Option Id', AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT per la tabella `rating_option_vote`
--
ALTER TABLE `rating_option_vote`
  MODIFY `vote_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Vote id';
--
-- AUTO_INCREMENT per la tabella `rating_option_vote_aggregated`
--
ALTER TABLE `rating_option_vote_aggregated`
  MODIFY `primary_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Vote aggregation id';
--
-- AUTO_INCREMENT per la tabella `reporting_counts`
--
ALTER TABLE `reporting_counts`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `reporting_module_status`
--
ALTER TABLE `reporting_module_status`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Module Id';
--
-- AUTO_INCREMENT per la tabella `reporting_orders`
--
ALTER TABLE `reporting_orders`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `reporting_system_updates`
--
ALTER TABLE `reporting_system_updates`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `reporting_users`
--
ALTER TABLE `reporting_users`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `report_compared_product_index`
--
ALTER TABLE `report_compared_product_index`
  MODIFY `index_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Index Id';
--
-- AUTO_INCREMENT per la tabella `report_event`
--
ALTER TABLE `report_event`
  MODIFY `event_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Event Id';
--
-- AUTO_INCREMENT per la tabella `report_event_types`
--
ALTER TABLE `report_event_types`
  MODIFY `event_type_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Event Type Id', AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT per la tabella `report_viewed_product_aggregated_daily`
--
ALTER TABLE `report_viewed_product_aggregated_daily`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `report_viewed_product_aggregated_monthly`
--
ALTER TABLE `report_viewed_product_aggregated_monthly`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `report_viewed_product_aggregated_yearly`
--
ALTER TABLE `report_viewed_product_aggregated_yearly`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `report_viewed_product_index`
--
ALTER TABLE `report_viewed_product_index`
  MODIFY `index_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Index Id';
--
...
--
-- AUTO_INCREMENT per la tabella `review_detail`
--
ALTER TABLE `review_detail`
  MODIFY `detail_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Review detail id';
--
-- AUTO_INCREMENT per la tabella `review_entity`
--
ALTER TABLE `review_entity`
  MODIFY `entity_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Review entity id', AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT per la tabella `review_entity_summary`
--
ALTER TABLE `review_entity_summary`
  MODIFY `primary_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Summary review entity id';
--
-- AUTO_INCREMENT per la tabella `review_status`
--
ALTER TABLE `review_status`
  MODIFY `status_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Status id', AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT per la tabella `salesrule`
--
ALTER TABLE `salesrule`
  MODIFY `rule_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Rule Id';
--
-- AUTO_INCREMENT per la tabella `salesrule_coupon`
--
ALTER TABLE `salesrule_coupon`
  MODIFY `coupon_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Coupon Id';
--
-- AUTO_INCREMENT per la tabella `salesrule_coupon_aggregated`
--
ALTER TABLE `salesrule_coupon_aggregated`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `salesrule_coupon_aggregated_order`
--
ALTER TABLE `salesrule_coupon_aggregated_order`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `salesrule_coupon_aggregated_updated`
--
ALTER TABLE `salesrule_coupon_aggregated_updated`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `salesrule_customer`
--
ALTER TABLE `salesrule_customer`
  MODIFY `rule_customer_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Rule Customer Id';
--
-- AUTO_INCREMENT per la tabella `salesrule_label`
--
ALTER TABLE `salesrule_label`
  MODIFY `label_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Label Id';
--
-- AUTO_INCREMENT per la tabella `sales_bestsellers_aggregated_daily`
--
ALTER TABLE `sales_bestsellers_aggregated_daily`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `sales_bestsellers_aggregated_monthly`
--
ALTER TABLE `sales_bestsellers_aggregated_monthly`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `sales_bestsellers_aggregated_yearly`
--
ALTER TABLE `sales_bestsellers_aggregated_yearly`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `sales_creditmemo`
--
ALTER TABLE `sales_creditmemo`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_creditmemo_comment`
--
ALTER TABLE `sales_creditmemo_comment`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_creditmemo_item`
--
ALTER TABLE `sales_creditmemo_item`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_invoice`
--
ALTER TABLE `sales_invoice`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_invoiced_aggregated`
--
ALTER TABLE `sales_invoiced_aggregated`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `sales_invoiced_aggregated_order`
--
ALTER TABLE `sales_invoiced_aggregated_order`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `sales_invoice_comment`
--
ALTER TABLE `sales_invoice_comment`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_invoice_item`
--
ALTER TABLE `sales_invoice_item`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_order`
--
ALTER TABLE `sales_order`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_order_address`
--
ALTER TABLE `sales_order_address`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_order_aggregated_created`
--
ALTER TABLE `sales_order_aggregated_created`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `sales_order_aggregated_updated`
--
ALTER TABLE `sales_order_aggregated_updated`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `sales_order_item`
--
ALTER TABLE `sales_order_item`
  MODIFY `item_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Item Id';
--
-- AUTO_INCREMENT per la tabella `sales_order_payment`
--
ALTER TABLE `sales_order_payment`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_order_status_history`
--
ALTER TABLE `sales_order_status_history`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_order_tax`
--
ALTER TABLE `sales_order_tax`
  MODIFY `tax_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Tax Id';
--
-- AUTO_INCREMENT per la tabella `sales_order_tax_item`
--
ALTER TABLE `sales_order_tax_item`
  MODIFY `tax_item_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Tax Item Id';
--
-- AUTO_INCREMENT per la tabella `sales_payment_transaction`
--
ALTER TABLE `sales_payment_transaction`
  MODIFY `transaction_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Transaction Id';
--
-- AUTO_INCREMENT per la tabella `sales_refunded_aggregated`
--
ALTER TABLE `sales_refunded_aggregated`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `sales_refunded_aggregated_order`
--
ALTER TABLE `sales_refunded_aggregated_order`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `sales_sequence_meta`
--
ALTER TABLE `sales_sequence_meta`
  MODIFY `meta_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id', AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT per la tabella `sales_sequence_profile`
--
ALTER TABLE `sales_sequence_profile`
  MODIFY `profile_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id', AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT per la tabella `sales_shipment`
--
ALTER TABLE `sales_shipment`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_shipment_comment`
--
ALTER TABLE `sales_shipment_comment`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_shipment_item`
--
ALTER TABLE `sales_shipment_item`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_shipment_track`
--
ALTER TABLE `sales_shipment_track`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `sales_shipping_aggregated`
--
ALTER TABLE `sales_shipping_aggregated`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `sales_shipping_aggregated_order`
--
ALTER TABLE `sales_shipping_aggregated_order`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id';
--
-- AUTO_INCREMENT per la tabella `search_query`
--
ALTER TABLE `search_query`
  MODIFY `query_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Query ID';
--
-- AUTO_INCREMENT per la tabella `search_synonyms`
--
ALTER TABLE `search_synonyms`
  MODIFY `group_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Synonyms Group Id';
--
-- AUTO_INCREMENT per la tabella `sendfriend_log`
--
ALTER TABLE `sendfriend_log`
  MODIFY `log_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Log ID';
--
-- AUTO_INCREMENT per la tabella `sequence_creditmemo_0`
--
ALTER TABLE `sequence_creditmemo_0`
  MODIFY `sequence_value` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT per la tabella `sequence_creditmemo_1`
--
ALTER TABLE `sequence_creditmemo_1`
  MODIFY `sequence_value` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT per la tabella `sequence_invoice_0`
--
ALTER TABLE `sequence_invoice_0`
  MODIFY `sequence_value` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT per la tabella `sequence_invoice_1`
--
ALTER TABLE `sequence_invoice_1`
  MODIFY `sequence_value` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT per la tabella `sequence_order_0`
--
ALTER TABLE `sequence_order_0`
  MODIFY `sequence_value` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT per la tabella `sequence_order_1`
--
ALTER TABLE `sequence_order_1`
  MODIFY `sequence_value` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT per la tabella `sequence_shipment_0`
--
ALTER TABLE `sequence_shipment_0`
  MODIFY `sequence_value` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT per la tabella `sequence_shipment_1`
--
ALTER TABLE `sequence_shipment_1`
  MODIFY `sequence_value` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT per la tabella `shipping_tablerate`
--
ALTER TABLE `shipping_tablerate`
  MODIFY `pk` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key';
--
-- AUTO_INCREMENT per la tabella `sitemap`
--
ALTER TABLE `sitemap`
...
--
-- AUTO_INCREMENT per la tabella `theme_file`
--
ALTER TABLE `theme_file`
  MODIFY `theme_files_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Theme files identifier';
--
-- AUTO_INCREMENT per la tabella `translation`
--
ALTER TABLE `translation`
  MODIFY `key_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Key Id of Translation';
--
-- AUTO_INCREMENT per la tabella `ui_bookmark`
--
ALTER TABLE `ui_bookmark`
  MODIFY `bookmark_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Bookmark identifier', AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT per la tabella `url_rewrite`
--
ALTER TABLE `url_rewrite`
...
--
-- AUTO_INCREMENT per la tabella `variable_value`
--
ALTER TABLE `variable_value`
  MODIFY `value_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Variable Value Id';
--
-- AUTO_INCREMENT per la tabella `vault_payment_token`
--
ALTER TABLE `vault_payment_token`
  MODIFY `entity_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity Id';
--
-- AUTO_INCREMENT per la tabella `weee_tax`
--
ALTER TABLE `weee_tax`
  MODIFY `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id';
--
...
--
-- AUTO_INCREMENT per la tabella `widget_instance`
--
ALTER TABLE `widget_instance`
  MODIFY `instance_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Instance Id';
--
-- AUTO_INCREMENT per la tabella `widget_instance_page`
--
ALTER TABLE `widget_instance_page`
...
--
-- AUTO_INCREMENT per la tabella `wishlist_item`
--
ALTER TABLE `wishlist_item`
  MODIFY `wishlist_item_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Wishlist item ID';
--
-- AUTO_INCREMENT per la tabella `wishlist_item_option`
--
ALTER TABLE `wishlist_item_option`
  MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Option Id';
--
...
--
-- Limiti per la tabella `admin_passwords`
--
ALTER TABLE `admin_passwords`
...
--
-- Limiti per la tabella `admin_user_session`
--
ALTER TABLE `admin_user_session`
...
--
-- Limiti per la tabella `authorization_rule`
--
ALTER TABLE `authorization_rule`
...
--
-- Limiti per la tabella `cataloginventory_stock_item`
--
ALTER TABLE `cataloginventory_stock_item`
...
--
-- Limiti per la tabella `catalogrule_customer_group`
--
ALTER TABLE `catalogrule_customer_group`
...
--
-- Limiti per la tabella `catalogrule_group_website`
--
ALTER TABLE `catalogrule_group_website`
...
--
-- Limiti per la tabella `catalogrule_website`
--
ALTER TABLE `catalogrule_website`
...
--
-- Limiti per la tabella `catalog_category_entity_datetime`
--
ALTER TABLE `catalog_category_entity_datetime`
...
--
-- Limiti per la tabella `catalog_category_entity_decimal`
--
ALTER TABLE `catalog_category_entity_decimal`
...
--
-- Limiti per la tabella `catalog_category_entity_int`
--
ALTER TABLE `catalog_category_entity_int`
...
--
-- Limiti per la tabella `catalog_category_entity_text`
--
ALTER TABLE `catalog_category_entity_text`
...
--
-- Limiti per la tabella `catalog_category_entity_varchar`
--
ALTER TABLE `catalog_category_entity_varchar`
...
--
-- Limiti per la tabella `catalog_compare_item`
--
ALTER TABLE `catalog_compare_item`
...
--
-- Limiti per la tabella `catalog_eav_attribute`
--
ALTER TABLE `catalog_eav_attribute`
...
--
-- Limiti per la tabella `catalog_product_bundle_option`
--
ALTER TABLE `catalog_product_bundle_option`
...
--
-- Limiti per la tabella `catalog_product_bundle_option_value`
--
ALTER TABLE `catalog_product_bundle_option_value`
...
--
-- Limiti per la tabella `catalog_product_bundle_price_index`
--
ALTER TABLE `catalog_product_bundle_price_index`
...
--
-- Limiti per la tabella `catalog_product_bundle_selection`
--
ALTER TABLE `catalog_product_bundle_selection`
...
--
-- Limiti per la tabella `catalog_product_bundle_selection_price`
--
ALTER TABLE `catalog_product_bundle_selection_price`
...
--
-- Limiti per la tabella `catalog_product_entity`
--
ALTER TABLE `catalog_product_entity`
...
--
-- Limiti per la tabella `catalog_product_entity_datetime`
--
ALTER TABLE `catalog_product_entity_datetime`
...
--
-- Limiti per la tabella `catalog_product_entity_decimal`
--
ALTER TABLE `catalog_product_entity_decimal`
...
--
-- Limiti per la tabella `catalog_product_entity_gallery`
--
ALTER TABLE `catalog_product_entity_gallery`
...
--
-- Limiti per la tabella `catalog_product_entity_int`
--
ALTER TABLE `catalog_product_entity_int`
...
--
-- Limiti per la tabella `catalog_product_entity_media_gallery`
--
ALTER TABLE `catalog_product_entity_media_gallery`
...
--
-- Limiti per la tabella `catalog_product_entity_media_gallery_value`
--
ALTER TABLE `catalog_product_entity_media_gallery_value`
...
--
-- Limiti per la tabella `catalog_product_entity_media_gallery_value_to_entity`
--
ALTER TABLE `catalog_product_entity_media_gallery_value_to_entity`
...
--
-- Limiti per la tabella `catalog_product_entity_media_gallery_value_video`
--
ALTER TABLE `catalog_product_entity_media_gallery_value_video`
...
--
-- Limiti per la tabella `catalog_product_entity_text`
--
ALTER TABLE `catalog_product_entity_text`
...
--
-- Limiti per la tabella `catalog_product_entity_tier_price`
--
ALTER TABLE `catalog_product_entity_tier_price`
...
--
-- Limiti per la tabella `catalog_product_entity_varchar`
--
ALTER TABLE `catalog_product_entity_varchar`
...
--
-- Limiti per la tabella `catalog_product_index_price`
--
ALTER TABLE `catalog_product_index_price`
...
--
-- Limiti per la tabella `catalog_product_index_tier_price`
--
ALTER TABLE `catalog_product_index_tier_price`
...
--
-- Limiti per la tabella `catalog_product_index_website`
--
ALTER TABLE `catalog_product_index_website`
...
--
-- Limiti per la tabella `catalog_product_link`
--
ALTER TABLE `catalog_product_link`
...
--
-- Limiti per la tabella `catalog_product_link_attribute`
--
ALTER TABLE `catalog_product_link_attribute`
...
--
-- Limiti per la tabella `catalog_product_link_attribute_decimal`
--
ALTER TABLE `catalog_product_link_attribute_decimal`
...
--
-- Limiti per la tabella `catalog_product_link_attribute_int`
--
ALTER TABLE `catalog_product_link_attribute_int`
...
--
-- Limiti per la tabella `catalog_product_link_attribute_varchar`
--
ALTER TABLE `catalog_product_link_attribute_varchar`
...
--
-- Limiti per la tabella `catalog_product_option`
--
ALTER TABLE `catalog_product_option`
...
--
-- Limiti per la tabella `catalog_product_option_price`
--
ALTER TABLE `catalog_product_option_price`
...
--
-- Limiti per la tabella `catalog_product_option_title`
--
ALTER TABLE `catalog_product_option_title`
...
--
-- Limiti per la tabella `catalog_product_option_type_price`
--
ALTER TABLE `catalog_product_option_type_price`
...
--
-- Limiti per la tabella `catalog_product_option_type_title`
--
ALTER TABLE `catalog_product_option_type_title`
...
--
-- Limiti per la tabella `catalog_product_option_type_value`
--
ALTER TABLE `catalog_product_option_type_value`
...
--
-- Limiti per la tabella `catalog_product_relation`
--
ALTER TABLE `catalog_product_relation`
...
--
-- Limiti per la tabella `catalog_product_super_attribute`
--
ALTER TABLE `catalog_product_super_attribute`
...
--
-- Limiti per la tabella `catalog_product_super_attribute_label`
--
ALTER TABLE `catalog_product_super_attribute_label`
...
--
-- Limiti per la tabella `catalog_product_super_link`
--
ALTER TABLE `catalog_product_super_link`
...
--
-- Limiti per la tabella `catalog_product_website`
--
ALTER TABLE `catalog_product_website`
...
--
-- Limiti per la tabella `catalog_url_rewrite_product_category`
--
ALTER TABLE `catalog_url_rewrite_product_category`
...
--
-- Limiti per la tabella `checkout_agreement_store`
--
ALTER TABLE `checkout_agreement_store`
...
--
-- Limiti per la tabella `cms_block_store`
--
ALTER TABLE `cms_block_store`
...
--
-- Limiti per la tabella `cms_page_store`
--
ALTER TABLE `cms_page_store`
...
--
-- Limiti per la tabella `customer_address_entity`
--
ALTER TABLE `customer_address_entity`
...
--
-- Limiti per la tabella `customer_address_entity_datetime`
--
ALTER TABLE `customer_address_entity_datetime`
...
--
-- Limiti per la tabella `customer_address_entity_decimal`
--
ALTER TABLE `customer_address_entity_decimal`
...
--
-- Limiti per la tabella `customer_address_entity_int`
--
ALTER TABLE `customer_address_entity_int`
...
--
-- Limiti per la tabella `customer_address_entity_text`
--
ALTER TABLE `customer_address_entity_text`
...
--
-- Limiti per la tabella `customer_address_entity_varchar`
--
ALTER TABLE `customer_address_entity_varchar`
...
--
-- Limiti per la tabella `customer_eav_attribute`
--
ALTER TABLE `customer_eav_attribute`
...
--
-- Limiti per la tabella `customer_eav_attribute_website`
--
ALTER TABLE `customer_eav_attribute_website`
...
--
-- Limiti per la tabella `customer_entity`
--
ALTER TABLE `customer_entity`
...
--
-- Limiti per la tabella `customer_entity_datetime`
--
ALTER TABLE `customer_entity_datetime`
...
--
-- Limiti per la tabella `customer_entity_decimal`
--
ALTER TABLE `customer_entity_decimal`
...
--
-- Limiti per la tabella `customer_entity_int`
--
ALTER TABLE `customer_entity_int`
...
--
-- Limiti per la tabella `customer_entity_text`
--
ALTER TABLE `customer_entity_text`
...
--
-- Limiti per la tabella `customer_entity_varchar`
--
ALTER TABLE `customer_entity_varchar`
...
--
-- Limiti per la tabella `customer_form_attribute`
--
ALTER TABLE `customer_form_attribute`
...
--
-- Limiti per la tabella `downloadable_link`
--
ALTER TABLE `downloadable_link`
...
--
-- Limiti per la tabella `downloadable_link_price`
--
ALTER TABLE `downloadable_link_price`
...
--
-- Limiti per la tabella `downloadable_link_purchased`
--
ALTER TABLE `downloadable_link_purchased`
...
--
-- Limiti per la tabella `downloadable_link_purchased_item`
--
ALTER TABLE `downloadable_link_purchased_item`
...
--
-- Limiti per la tabella `downloadable_link_title`
--
ALTER TABLE `downloadable_link_title`
...
--
-- Limiti per la tabella `downloadable_sample`
--
ALTER TABLE `downloadable_sample`
...
--
-- Limiti per la tabella `downloadable_sample_title`
--
ALTER TABLE `downloadable_sample_title`
...
--
-- Limiti per la tabella `eav_attribute_group`
--
ALTER TABLE `eav_attribute_group`
...
--
-- Limiti per la tabella `eav_attribute_label`
--
ALTER TABLE `eav_attribute_label`
...
--
-- Limiti per la tabella `eav_attribute_option`
--
ALTER TABLE `eav_attribute_option`
...
--
-- Limiti per la tabella `eav_attribute_option_swatch`
--
ALTER TABLE `eav_attribute_option_swatch`
...
--
-- Limiti per la tabella `eav_attribute_option_value`
--
ALTER TABLE `eav_attribute_option_value`
...
--
-- Limiti per la tabella `eav_attribute_set`
--
ALTER TABLE `eav_attribute_set`
...
--
-- Limiti per la tabella `eav_entity`
--
ALTER TABLE `eav_entity`
...
--
-- Limiti per la tabella `eav_entity_attribute`
--
ALTER TABLE `eav_entity_attribute`
...
--
-- Limiti per la tabella `eav_entity_datetime`
--
ALTER TABLE `eav_entity_datetime`
...
--
-- Limiti per la tabella `eav_entity_decimal`
--
ALTER TABLE `eav_entity_decimal`
...
--
-- Limiti per la tabella `eav_entity_int`
--
ALTER TABLE `eav_entity_int`
...
--
-- Limiti per la tabella `eav_entity_store`
--
ALTER TABLE `eav_entity_store`
...
--
-- Limiti per la tabella `eav_entity_text`
--
ALTER TABLE `eav_entity_text`
...
--
-- Limiti per la tabella `eav_entity_varchar`
--
ALTER TABLE `eav_entity_varchar`
...
--
-- Limiti per la tabella `eav_form_element`
--
ALTER TABLE `eav_form_element`
...
--
-- Limiti per la tabella `eav_form_fieldset`
--
ALTER TABLE `eav_form_fieldset`
...
--
-- Limiti per la tabella `eav_form_fieldset_label`
--
ALTER TABLE `eav_form_fieldset_label`
...
--
-- Limiti per la tabella `googleoptimizer_code`
--
ALTER TABLE `googleoptimizer_code`
...
--
-- Limiti per la tabella `integration`
--
ALTER TABLE `integration`
...
--
-- Limiti per la tabella `layout_link`
--
ALTER TABLE `layout_link`
...
--
-- Limiti per la tabella `newsletter_problem`
--
ALTER TABLE `newsletter_problem`
...
--
-- Limiti per la tabella `newsletter_queue`
--
ALTER TABLE `newsletter_queue`
...
--
-- Limiti per la tabella `newsletter_queue_link`
--
ALTER TABLE `newsletter_queue_link`
...
--
-- Limiti per la tabella `newsletter_queue_store_link`
--
ALTER TABLE `newsletter_queue_store_link`
...
--
-- Limiti per la tabella `newsletter_subscriber`
--
ALTER TABLE `newsletter_subscriber`
...
--
-- Limiti per la tabella `oauth_nonce`
--
ALTER TABLE `oauth_nonce`
...
--
-- Limiti per la tabella `oauth_token`
--
ALTER TABLE `oauth_token`
...
--
-- Limiti per la tabella `paypal_billing_agreement`
--
ALTER TABLE `paypal_billing_agreement`
...
--
-- Limiti per la tabella `paypal_billing_agreement_order`
--
ALTER TABLE `paypal_billing_agreement_order`
...
--
-- Limiti per la tabella `paypal_cert`
--
ALTER TABLE `paypal_cert`
...
--
-- Limiti per la tabella `paypal_settlement_report_row`
--
ALTER TABLE `paypal_settlement_report_row`
...
--
-- Limiti per la tabella `persistent_session`
--
ALTER TABLE `persistent_session`
...
--
-- Limiti per la tabella `product_alert_price`
--
ALTER TABLE `product_alert_price`
...
--
-- Limiti per la tabella `product_alert_stock`
--
ALTER TABLE `product_alert_stock`
...
--
-- Limiti per la tabella `quote_item_option`
--
ALTER TABLE `quote_item_option`
...
--
-- Limiti per la tabella `rating_option`
--
ALTER TABLE `rating_option`
...
--
-- Limiti per la tabella `rating_option_vote`
--
ALTER TABLE `rating_option_vote`
...
--
-- Limiti per la tabella `rating_option_vote_aggregated`
--
ALTER TABLE `rating_option_vote_aggregated`
...
--
-- Limiti per la tabella `rating_store`
--
ALTER TABLE `rating_store`
...
--
-- Limiti per la tabella `rating_title`
--
ALTER TABLE `rating_title`
...
--
-- Limiti per la tabella `report_compared_product_index`
--
ALTER TABLE `report_compared_product_index`
...
--
-- Limiti per la tabella `report_event`
--
ALTER TABLE `report_event`
...
--
-- Limiti per la tabella `report_viewed_product_aggregated_daily`
--
ALTER TABLE `report_viewed_product_aggregated_daily`
...
--
-- Limiti per la tabella `report_viewed_product_aggregated_monthly`
--
ALTER TABLE `report_viewed_product_aggregated_monthly`
...
--
-- Limiti per la tabella `report_viewed_product_aggregated_yearly`
--
ALTER TABLE `report_viewed_product_aggregated_yearly`
...
--
-- Limiti per la tabella `report_viewed_product_index`
--
ALTER TABLE `report_viewed_product_index`
...
--
-- Limiti per la tabella `review_detail`
--
ALTER TABLE `review_detail`
...
--
-- Limiti per la tabella `review_entity_summary`
--
ALTER TABLE `review_entity_summary`
...
--
-- Limiti per la tabella `review_store`
--
ALTER TABLE `review_store`
...
--
-- Limiti per la tabella `salesrule_coupon`
--
ALTER TABLE `salesrule_coupon`
...
--
-- Limiti per la tabella `salesrule_coupon_aggregated`
--
ALTER TABLE `salesrule_coupon_aggregated`
...
--
-- Limiti per la tabella `salesrule_coupon_aggregated_order`
--
ALTER TABLE `salesrule_coupon_aggregated_order`
...
--
-- Limiti per la tabella `salesrule_coupon_aggregated_updated`
--
ALTER TABLE `salesrule_coupon_aggregated_updated`
...
--
-- Limiti per la tabella `salesrule_coupon_usage`
--
ALTER TABLE `salesrule_coupon_usage`
...
--
-- Limiti per la tabella `salesrule_customer`
--
ALTER TABLE `salesrule_customer`
...
--
-- Limiti per la tabella `salesrule_customer_group`
--
ALTER TABLE `salesrule_customer_group`
...
--
-- Limiti per la tabella `salesrule_label`
--
ALTER TABLE `salesrule_label`
...
--
-- Limiti per la tabella `salesrule_product_attribute`
--
ALTER TABLE `salesrule_product_attribute`
...
--
-- Limiti per la tabella `salesrule_website`
--
ALTER TABLE `salesrule_website`
...
--
-- Limiti per la tabella `sales_bestsellers_aggregated_daily`
--
ALTER TABLE `sales_bestsellers_aggregated_daily`
...
--
-- Limiti per la tabella `sales_bestsellers_aggregated_monthly`
--
ALTER TABLE `sales_bestsellers_aggregated_monthly`
...
--
-- Limiti per la tabella `sales_bestsellers_aggregated_yearly`
--
ALTER TABLE `sales_bestsellers_aggregated_yearly`
...
--
-- Limiti per la tabella `sales_creditmemo`
--
ALTER TABLE `sales_creditmemo`
...
--
-- Limiti per la tabella `sales_creditmemo_comment`
--
ALTER TABLE `sales_creditmemo_comment`
...
--
-- Limiti per la tabella `sales_creditmemo_item`
--
ALTER TABLE `sales_creditmemo_item`
...
--
-- Limiti per la tabella `sales_invoice`
--
ALTER TABLE `sales_invoice`
...
--
-- Limiti per la tabella `sales_invoiced_aggregated`
--
ALTER TABLE `sales_invoiced_aggregated`
...
--
-- Limiti per la tabella `sales_invoiced_aggregated_order`
--
ALTER TABLE `sales_invoiced_aggregated_order`
...
--
-- Limiti per la tabella `sales_invoice_comment`
--
ALTER TABLE `sales_invoice_comment`
...
--
-- Limiti per la tabella `sales_invoice_item`
--
ALTER TABLE `sales_invoice_item`
...
--
-- Limiti per la tabella `sales_order`
--
ALTER TABLE `sales_order`
...
--
-- Limiti per la tabella `sales_order_address`
--
ALTER TABLE `sales_order_address`
...
--
-- Limiti per la tabella `sales_order_aggregated_created`
--
ALTER TABLE `sales_order_aggregated_created`
...
--
-- Limiti per la tabella `sales_order_aggregated_updated`
--
ALTER TABLE `sales_order_aggregated_updated`
...
--
-- Limiti per la tabella `sales_order_item`
--
ALTER TABLE `sales_order_item`
...
--
-- Limiti per la tabella `sales_order_payment`
--
ALTER TABLE `sales_order_payment`
...
--
-- Limiti per la tabella `sales_order_status_history`
--
ALTER TABLE `sales_order_status_history`
...
--
-- Limiti per la tabella `sales_order_status_label`
--
ALTER TABLE `sales_order_status_label`
...
--
-- Limiti per la tabella `sales_order_status_state`
--
ALTER TABLE `sales_order_status_state`
...
--
-- Limiti per la tabella `sales_order_tax_item`
--
ALTER TABLE `sales_order_tax_item`
...
--
-- Limiti per la tabella `sales_payment_transaction`
--
ALTER TABLE `sales_payment_transaction`
...
--
-- Limiti per la tabella `sales_refunded_aggregated`
--
ALTER TABLE `sales_refunded_aggregated`
...
--
-- Limiti per la tabella `sales_refunded_aggregated_order`
--
ALTER TABLE `sales_refunded_aggregated_order`
...
--
-- Limiti per la tabella `sales_sequence_profile`
--
ALTER TABLE `sales_sequence_profile`
...
--
-- Limiti per la tabella `sales_shipment`
--
ALTER TABLE `sales_shipment`
...
--
-- Limiti per la tabella `sales_shipment_comment`
--
ALTER TABLE `sales_shipment_comment`
...
--
-- Limiti per la tabella `sales_shipment_item`
--
ALTER TABLE `sales_shipment_item`
...
--
-- Limiti per la tabella `sales_shipment_track`
--
ALTER TABLE `sales_shipment_track`
...
--
-- Limiti per la tabella `sales_shipping_aggregated`
--
ALTER TABLE `sales_shipping_aggregated`
...
--
-- Limiti per la tabella `sales_shipping_aggregated_order`
--
ALTER TABLE `sales_shipping_aggregated_order`
...
--
-- Limiti per la tabella `store_group`
--
ALTER TABLE `store_group`
...
--
-- Limiti per la tabella `tax_calculation`
--
ALTER TABLE `tax_calculation`
...
--
-- Limiti per la tabella `tax_calculation_rate_title`
--
ALTER TABLE `tax_calculation_rate_title`
...
--
-- Limiti per la tabella `tax_order_aggregated_created`
--
ALTER TABLE `tax_order_aggregated_created`
...
--
-- Limiti per la tabella `tax_order_aggregated_updated`
--
ALTER TABLE `tax_order_aggregated_updated`
...
--
-- Limiti per la tabella `variable_value`
--
ALTER TABLE `variable_value`
...
--
-- Limiti per la tabella `vault_payment_token`
--
ALTER TABLE `vault_payment_token`
...
--
-- Limiti per la tabella `vault_payment_token_order_payment_link`
--
ALTER TABLE `vault_payment_token_order_payment_link`
...
--
-- Limiti per la tabella `weee_tax`
--
ALTER TABLE `weee_tax`
...
--
-- Limiti per la tabella `widget_instance_page_layout`
--
ALTER TABLE `widget_instance_page_layout`
...
--
-- Limiti per la tabella `wishlist_item`
--
ALTER TABLE `wishlist_item`
...
--
-- Limiti per la tabella `wishlist_item_option`
--
ALTER TABLE `wishlist_item_option`
